    ...
    <div className="mx-auto max-w-screen-xl">
        <div className="md:flex md:justify-between">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2">
                <div>
                    <h2 className="mb-6 text-md text-white uppercase dark:text-white">Contact Us</h2>
                    <ul className="text-gray-600 dark:text-white">
                        <li className="mb-4">
                            <a href="tel:+14239540710" className="hover:underline ">(423)-954-0710</a>
                        </li>
                        <li>
                            <a href="mailto:contact@snapdragonhemp.com" className="hover:underline">Contact@snapdragonhemp.com</a>
                        </li>
                    </ul>
                </div>
                <div>
                    <h2 className="mb-6 text-md text-white uppercase dark:text-white">Legal</h2>
                    <ul className="text-gray-600 dark:text-white">
                        <li className="mb-4">
                            <a href="https://www.snapdragonhemp.com/privacy-policy/" className="hover:underline">Privacy Policy</a>
                        </li>
                        <li>
                            <a href="https://www.snapdragonhemp.com/terms-of-service/" className="hover:underline">Terms &amp; Conditions</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-white sm:text-center dark:text-white">© 2024 <a href="https://snapdragonhemp.com" className="hover:underline">The Dragon™</a>. All Rights Reserved.
            </span>
