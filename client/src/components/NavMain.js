...
<nav className="bg-black border-gray-200">
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <a href="https://snapdragonhemp.com/" className="flex items-center space-x-3 rtl:space-x-reverse">
    ...
    <button data-collapse-toggle="navbar-default" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-white rounded-lg md:hidden hover:bg-black focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-white dark:hover:bg-black dark:focus:ring-gray-600" aria-controls="navbar-default" aria-expanded="false">
    ...
    <div className="hidden w-full md:block md:w-auto" id="navbar-default">
      <ul className="font-bold flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-black dark:bg-gray-800 md:dark:bg-black dark:border-gray-700">
        <li>
          <Link to='/'>
          <button className="block py-2 px-3 text-white rounded md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-yellow-400 hover:bg-gray-700">Home</button>
          </Link>
        </li>
        <li>
          <Link>
          <button onClick={scrollToAbout} className="block py-2 px-3 text-white rounded md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-yellow-400 hover:bg-gray-700">About</button>
          </Link>
          </li>
        <li>
        <Link to='/menu'>
          <button className="block py-2 px-3 text-white rounded md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-yellow-400 hover:bg-gray-700">Menu</button>
          </Link>
          
          </li>
        <li>
        <Link onClick={scrollToBottom}>
          <button className="block py-2 px-3 text-white rounded md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-yellow-400 hover:bg-gray-700">Contact</button>
          </Link> </li>
        <li>
